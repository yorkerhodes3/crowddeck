...
| **ENG-7** | **Real-time safety audit**<br>Assert no allocation, locks, logging or I/O in the audio callback. Count and surface xruns as CDEP events. | M | build | `REQ-NFR-1` `REQ-NFR-2` |
