  ...
  "requirements": {
    ...
    "requirements": [
      ...
      },
      {
        ...
        "level": "MUST",
        "capabilities": [],
        "text": "jukeboxControl MUST be implemented, and MUST support the jukeboxMediaTypes extension rather than song IDs only."
      },
      {
        "id": "REQ-API-12",
        "group": "API",
        ...
        "level": "MUST",
        "capabilities": [],
        "text": "Subsonic-authenticated clients MUST be treated as staff-level, since the Subsonic auth model has no patron concept."
      },
      {
        "id": "REQ-MIDI-1",
        "group": "MIDI",
    ...
    "epics": [
      {
        ...
        "stories": [
          ...
          {
            "id": "LEGAL-1",
            "name": "Legal review of the ADR-001 IPC boundary",
            "size": "S",
            "verdict": null,
            "reqs": [
              "REQ-LIC-2",
        ...
        "stories": [
          {
            ...
            "detail": "Keep engine, audio, soundio, mixer, analyzer, effects, control, controllers, sources, track. Delete skin, widget, qml, dialog, preferences, rendergraph, shaders. SPIKE-1: effects is NOT optional — per-deck EQ is routed through [EqualizerRack1_[ChannelN]_Effect1], so the rack must be retained. SPIKE-1 also found EngineMixer includes only QtCore, so the headless strip is less risky than assumed.",
            "status": "todo"
          },
          {
            "id": "ENG-2",
          ...
          },
          {
            ...
            "detail": "Inherited from Mixxx; wire to the CDEP control set. SPIKE-1: EQ is an effects-rack unit, not a deck control — budget for wiring [EqualizerRack1_[ChannelN]_Effect1]/parameter1..3.",
            "status": "todo"
          },
          {
            "id": "ENG-4",
