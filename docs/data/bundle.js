  ...
  "requirements": {
    ...
    "requirements": [
      ...
      },
      {
        ...
        "level": "MUST",
        "capabilities": [],
        "text": "describe MUST return every control with a descriptor: group, item, type (bool | int | float | enum), min, max, default, readonly, and a human label."
      },
      {
        "id": "REQ-CDEP-13",
        "group": "CDEP",
        ...
        "level": "MUST",
        "capabilities": [],
        "text": "The description MUST be sufficient to build a complete control UI and a complete MIDI-mapping target list with no hard-coded knowledge of the engine."
      },
      {
        "id": "REQ-CDEP-14",
        "group": "CDEP",
