...
| **4 — Build** | `protocol/` `core/` `data/` `api/` `interconnect/` `clients/` | 🚧 **In progress — M1–M3 + MIDI + persistence + content, 45/61 stories** |
...
**574 tests · 20 conformance checks · zero runtime dependencies.**
