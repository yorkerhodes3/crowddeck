...
| **4 — Build** | `protocol/` `core/` `data/` `api/` `interconnect/` `clients/` | 🚧 **In progress — M1–M3 + MIDI + persistence + content, 44/61 stories** |
...
**528 tests · 20 conformance checks · zero runtime dependencies.**
